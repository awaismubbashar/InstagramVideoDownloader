package com.downloader.instagramvideodownloader.services;
...
import com.downloader.instagramvideodownloader.MainActivity;
import com.downloader.instagramvideodownloader.R;
import com.downloader.instagramvideodownloader.tasks.downloadVideo;

import static com.downloader.instagramvideodownloader.utils.Constants.STARTFOREGROUND_ACTION;
import static com.downloader.instagramvideodownloader.utils.Constants.STOPFOREGROUND_ACTION;
...
public class ClipboardMonitor extends Service {
    ...
    private  void stopForegroundService(){
        ...
        prefs = getSharedPreferences("instaVideoDownloader", MODE_PRIVATE);
    ...
    private void startInForeground() {
        ...
        if(Build.VERSION.SDK_INT>=26) {
            ...
            channel.setDescription("Instagram Auto Download");
